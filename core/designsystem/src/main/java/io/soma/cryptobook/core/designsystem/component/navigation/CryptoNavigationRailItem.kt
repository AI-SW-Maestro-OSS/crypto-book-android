...
import io.soma.cryptobook.core.designsystem.component.navigation.color.cryptoNavigationRailItemColors

@Composable
fun CryptoNavigationRailItem(
    ...
    NavigationRailItem(
        ...
        onClick = onClick,
        modifier = modifier,
        colors = cryptoNavigationRailItemColors(),
    )
}